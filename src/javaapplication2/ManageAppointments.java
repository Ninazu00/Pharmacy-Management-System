...
public class ManageAppointments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setForeground(new java.awt.Color(37, 95, 214));
        ...
        jTextField3.setForeground(new java.awt.Color(37, 95, 214));
        ...
        jTextField4.setForeground(new java.awt.Color(37, 95, 214));
        ...
        jTextField5.setFont(new java.awt.Font("Gadugi", 1, 14)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(37, 95, 214));
    ...
    String doctorId = jTextField3.getText();
    String date = jTextField4.getText();
    String status = jTextField5.getText();

      if (id.isEmpty() || clientId.isEmpty() || doctorId.isEmpty() || date.isEmpty() || status.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please enter all appointment details.");
        return;
    }
    
    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    model.addRow(new Object[] {id, clientId, doctorId, date, status});
