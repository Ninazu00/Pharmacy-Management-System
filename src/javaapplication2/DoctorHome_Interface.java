 ...
 * @author Mohamed
 */
public class DoctorHome_Interface extends javax.swing.JFrame {

    /**
     * Creates new form DoctorHome_Interface
     */
    public DoctorHome_Interface() {
        initComponents();
        String temp = new String();
        temp = "Welcome back, Dr. ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome back, Dear Doctor");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        ViewAppointments next = new ViewAppointments();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorHome_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DoctorHome_Interface().setVisible(true);
            }
        });
    }
